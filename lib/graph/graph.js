...
var _edgeNum = /*#__PURE__*/new WeakMap();
var _adjacencyList = /*#__PURE__*/new WeakMap();
var Graph = /*#__PURE__*/function () {
  function Graph() {
    _classCallCheck(this, Graph);
    _classPrivateFieldInitSpec(this, _edgeNum, {
      writable: true,
      value: 0
    });
    _classPrivateFieldInitSpec(this, _adjacencyList, {
      writable: true,
      value: new Map()
    });
  }
  _createClass(Graph, [{
    ...
    value: function addVertex(vertex) {
      _classPrivateFieldGet(this, _adjacencyList).set(vertex, new Set());
    }
  }, {
    key: "addEdge",
    value: function addEdge(vertex1, vertex2) {
      ...
      var adjacentVertices = _classPrivateFieldGet(this, _adjacencyList).get(vertex1);
    ...
    value: function contains(vertex) {
      return _classPrivateFieldGet(this, _adjacencyList).has(vertex);
    }
  }, {
    key: "doesPathExist",
    value: function doesPathExist(startingVertex, targetVertex) {
      ...
      while (!frontierQueue.isEmpty()) {
        ...
        var adjacentVertices = _classPrivateFieldGet(this, _adjacencyList).get(currentVertex);
    ...
    value: function edgeCount() {
      return _classPrivateFieldGet(this, _edgeNum);
    }
  }, {
    key: "findShortestPaths",
    value: function findShortestPaths(startingVertex) {
      var unvistedQueue = new _queue.default();
      var _iterator = _createForOfIteratorHelper(_classPrivateFieldGet(this, _adjacencyList)),
        _step;
      try {
    ...
    value: function isAdjacent(terminatingVertex, startingVertex) {
      var startingVertexAdjacentSet = _classPrivateFieldGet(this, _adjacencyList).get(startingVertex);
    ...
    value: function isVertex() {
      ...
      return vertices.every(function (vertex) {
        return _classPrivateFieldGet(_this, _adjacencyList).has(vertex);
      });
    }
  }, {
    key: "printAdjanceyList",
    value: function printAdjanceyList() {
      var _iterator2 = _createForOfIteratorHelper(_classPrivateFieldGet(this, _adjacencyList)),
        _step2;
      try {
    ...
    value: function vertexCount() {
      return _classPrivateFieldGet(this, _adjacencyList).size;
    }
  }]);
  return Graph;
}();
