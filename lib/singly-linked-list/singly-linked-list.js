...
var _singlyLinkedListNode = _interopRequireDefault(require("./singly-linked-list-node.js"));
...
var SinglyLinkedList = /*#__PURE__*/function () {
  ...
  _createClass(SinglyLinkedList, [{
    ...
    value: function removeLast() {
      var _this$size9, _this$size10;
      if (this.isEmpty()) return null;
      if (this.size() === 1) {
        var lastValue = this.getLast();
        this.clear();
        return lastValue;
      }
      var currentNode = _classPrivateFieldGet(this, _head);
      ...
      _classPrivateFieldSet(this, _tail, currentNode);
      _classPrivateFieldSet(this, _size, (_this$size9 = _classPrivateFieldGet(this, _size), _this$size10 = _this$size9--, _this$size9)), _this$size10;
